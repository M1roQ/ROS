...
class TargetSwitcher(Node):
    def __init__(self):
        ...
        # Таймеры публикации и проверки авто-переключения
        ...
        # Поток для прослушивания ввода с клавиатуры для ручного переключения
    ...
    def timer_callback(self):
        ...
        # Публикация carrot1 вокруг turtle1
        ...
        # Публикация carrot2 вокруг turtle3
        ...
        # Публикация текущей цели в топик
        target_msg = String()
